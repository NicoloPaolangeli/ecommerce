...
public class Codici_Sconto {
	...
	public Codici_Sconto (int id_prodotti, int quantita, int id_clienti, int iva, int prezzo_totale, String data_ordine, String indirizzo_spedizione, String modalita_pagamento) {
	...
	public Codici_Sconto (int id_ordini, int id_prodotti, int quantita, int id_clienti, int iva, int prezzo_totale, String data_ordine, String indirizzo_spedizione, String modalita_pagamento) {
